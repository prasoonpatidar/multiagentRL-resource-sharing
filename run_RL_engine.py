...
from configs.train_configs import get_train_config, train_configs
from training.get_trainer import get_trainer
from training.learn_policy import learn_policy

if __name__ == '__main__':

    # train_config_names =  list(train_configs.keys())
    train_config_names = [sys.argv[1]]
    ...
    for train_config_name in train_config_names:
        ...
        # set action count in train config
